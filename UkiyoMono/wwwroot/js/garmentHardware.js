...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        "ajax": { url: `/${culture}/admin/GarmentHardware/getall` },
        "columns": [
            { data: 'name', "width": "15%" },
            ...
            { data: 'unitPrice', "width": "15%", render: window.SpanishNumberTables(culture) },
            {
               ...
               <a href="/${culture}/admin/GarmentHardware/upsert?id=${data}" class="btn btn-primary mx-2"><i class="bi bi-pencil-square"></i></a>
               <a onClick=Delete('/${culture}/admin/GarmentHardware/delete/${data}') class="btn btn-danger mx-2"><i class="bi bi-trash-fill"></i></a>
                    </div>`
                },
                "width": "20%"
            }
