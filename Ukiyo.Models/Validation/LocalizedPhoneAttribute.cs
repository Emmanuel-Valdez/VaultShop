...
{
	public sealed class LocalizedPhoneAttribute : ValidationAttribute, IClientModelValidator
	{
		...
		public LocalizedPhoneAttribute(string englishMessage, string spanishMessage)
		{
		...
		public void AddValidation(ClientModelValidationContext context)
		{
			...
			MergeAttribute(context.Attributes, "data-val-phone", FormatErrorMessage(context.ModelMetadata.GetDisplayName()));
		}
